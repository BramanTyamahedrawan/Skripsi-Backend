...
public class SeederDataAll {
    ...
    public static void main(String[] args) throws IOException {
        ...
        client.insertRecord(tableKonsentrasiKeahlianSekolah, "KKS001", "main", "idKonsentrasiSekolah", "KKS001");
        ...
        client.insertRecord(tableKonsentrasiKeahlianSekolah, "KKS001", "konsentrasiKeahlian", "konsentrasi",
                "Desain Komunikasi Visual");
        client.insertRecord(tableKonsentrasiKeahlianSekolah, "KKS001", "detail", "createdAt", instant.toString());

        client.insertRecord(tableKonsentrasiKeahlianSekolah, "KKS002", "main", "idKonsentrasiSekolah", "KKS002");
        ...
        client.insertRecord(tableKonsentrasiKeahlianSekolah, "KKS002", "konsentrasiKeahlian", "konsentrasi",
                "Agribisnis Perikanan Air Tawar");
        client.insertRecord(tableKonsentrasiKeahlianSekolah, "KKS002", "detail", "createdAt", instant.toString());

        client.insertRecord(tableKonsentrasiKeahlianSekolah, "KKS003", "main", "idKonsentrasiSekolah", "KKS003");
        ...
        client.insertRecord(tableKonsentrasiKeahlianSekolah, "KKS003", "konsentrasiKeahlian", "konsentrasi",
                "Desain dan Produksi Busana");
        client.insertRecord(tableKonsentrasiKeahlianSekolah, "KKS003", "detail", "createdAt", instant.toString());

        client.insertRecord(tableKonsentrasiKeahlianSekolah, "KKS004", "main", "idKonsentrasiSekolah", "KKS004");
        ...
        client.insertRecord(tableKonsentrasiKeahlianSekolah, "KKS004", "konsentrasiKeahlian", "konsentrasi",
                "Teknik Sepeda Motor");
        client.insertRecord(tableKonsentrasiKeahlianSekolah, "KKS004", "detail", "createdAt", instant.toString());
        ...
        // Insert Data Table Elemen
        client.insertRecord(tableElemen, "ELE001", "main", "idElemen", "ELE001");
        client.insertRecord(tableElemen, "ELE001", "main", "namaElemen", "Pengetahuan");
        client.insertRecord(tableElemen, "ELE001", "school", "idSchool", "RWK001");
        client.insertRecord(tableElemen, "ELE001", "school", "nameSchool", "SMK Negeri 01 ROWOKANGKUNG");
        client.insertRecord(tableElemen, "ELE001", "mapel", "idMapel", "MAP001");
        client.insertRecord(tableElemen, "ELE001", "mapel", "namaMapel", "Matematika");
        client.insertRecord(tableElemen, "ELE001", "tahunAjaran", "idTahun", "TA001");
        client.insertRecord(tableElemen, "ELE001", "tahunAjaran", "tahunAjaran", "2025/2026");
        client.insertRecord(tableElemen, "ELE001", "kelas", "idKelas", "KLS001");
        client.insertRecord(tableElemen, "ELE001", "kelas", "namaKelas", "X");
        client.insertRecord(tableElemen, "ELE001", "semester", "idSemester", "SM001");
        client.insertRecord(tableElemen, "ELE001", "semester", "namaSemester", "Ganjil");
        client.insertRecord(tableElemen, "ELE001", "konsentrasiKeahlianSekolah", "idKonsentrasiSekolah",
                "KKS001");
        client.insertRecord(tableElemen, "ELE001", "konsentrasiKeahlianSekolah", "namaKonsentrasiSekolah",
                "Desain Komunikasi Visual");
        client.insertRecord(tableElemen, "ELE001", "detail", "createdAt", instant.toString());
