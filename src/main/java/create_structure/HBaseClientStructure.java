...
public class HBaseClientStructure {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String[] elemen = { "main", "tahunAjaran", "mapels", "kelas", "semester", "detail" };
        ...
        String[] season = { "main", "bidangKeahlian", "programKeahlian", "konsentrasiKeahlian", "kelas", "tahunAjaran",
        ...
        String[] RPS = { "main", "learning_media_softwares", "learning_media_hardwares", "requirement_subjects",
                "study_program", "subject", "dev_lecturers", "teaching_lecturers", "coordinator_lecturers",
                "ka_study_program",
                "detail" };
        ...
        String[] RPSDetails = { "main", "rps", "learning_materials", "form_learning", "learning_methods", "assignments",
                "estimated_times", "student_learning_experiences", "assessment_criterias", "appraisal_forms",
        ...
        String[] criteriaValues = { "main", "detail", "team_teaching", "question", "user", "value1", "value2", "value3",
