...
public class BankSoalService {
    ...
    // public BankSoal updateSoalUjian(String bankSoalId, BankSoalRequest
    // bankSoalRequest) throws IOException {
    // // Check if question exists
    // SoalUjian existingSoal = bankSoalRepository.findById(bankSoalId);
    // if (existingSoal == null) {
    // throw new IllegalArgumentException("Soal ujian tidak ditemukan");
    // }

    // // Get related entities
    // User userResponse = userRepository.findById(bankSoalRequest.getIdUser());
    // Taksonomi taksonomiResponse =
    // taksonomiRepository.findById(bankSoalRequest.getIdTaksonomi());
    // KonsentrasiKeahlianSekolah konsentrasiKeahlianSekolahResponse =
    // konsentrasiKeahlianSekolahRepository
    // .findById(bankSoalRequest.getIdKonsentrasiSekolah());
    // School schoolResponse =
    // schoolRepository.findById(bankSoalRequest.getIdSchool());
    ...
    // updatedSoal.setNamaUjian(bankSoalRequest.getNamaUjian());
    // updatedSoal.setPertanyaan(bankSoalRequest.getPertanyaan());
    // updatedSoal.setBobot(bankSoalRequest.getBobot());
    // updatedSoal.setJenisSoal(bankSoalRequest.getJenisSoal());
    // updatedSoal.setCreatedAt(existingSoal.getCreatedAt()); // Keep original
    // creation date
    ...
    // case "PG":
    // validatePertanyaanPG(bankSoalRequest);
    // updatedSoal.setOpsi(bankSoalRequest.getOpsi());
    // updatedSoal.setJawabanBenar(bankSoalRequest.getJawabanBenar());
    // break;
    ...
    // case "COCOK":
    // validatePertanyaanCocok(bankSoalRequest);
    // updatedSoal.setPasangan(bankSoalRequest.getPasangan());
    // updatedSoal.setJawabanBenar(bankSoalRequest.getJawabanBenar());
    // break;
    ...
    // validatePertanyaanIsian(bankSoalRequest);
    // updatedSoal.setJawabanBenar(bankSoalRequest.getJawabanBenar());
    // updatedSoal.setToleransiTypo(bankSoalRequest.getToleransiTypo());
    // break;

    // default:
    // throw new IllegalArgumentException("Jenis soal tidak dikenali: " +
