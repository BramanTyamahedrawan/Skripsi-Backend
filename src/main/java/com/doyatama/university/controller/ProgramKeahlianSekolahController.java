...
public class ProgramKeahlianSekolahController {
    ...
    public PagedResponse<ProgramKeahlianSekolah> getProgramKeahlianSekolah(
            ...
            throws IOException {
        return programKeahlianSekolahService.getAllProgramKeahlianSekolah(page, size, schoolID, programKeahlianID);
    }

    @PostMapping
    public ResponseEntity<?> createProgramKeahlianSekolah(
            @Valid @RequestBody ProgramKeahlianSekolahRequest programKeahlianSekolahRequest) throws IOException {
        try {
            ...
            return ResponseEntity.created(location)
                    .body(new ApiResponse(true, "Program Keahlian Sekolah Created Successfully"));
    ...
    public ResponseEntity<?> updateProgramKeahlianSekolah(@PathVariable String programKeahlianSekolahId,
        ...
        try {
            ProgramKeahlianSekolah programKeahlianSekolah = programKeahlianSekolahService
                    .updateProgramKeahlianSekolah(programKeahlianSekolahId, programKeahlianSekolahRequest);
